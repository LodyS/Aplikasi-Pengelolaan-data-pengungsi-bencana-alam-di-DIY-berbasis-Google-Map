...
$cari_sakit = "SELECT posko.id_posko, nama, posko.nama_posko, riwayat_sakit.nama_penyakit FROM pengungsi 
...
WHERE pengungsi.id_riwayat_sakit = '$id_riwayat_sakit' AND posko.id_posko = '$id_posko';";
